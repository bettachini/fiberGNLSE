...
sim.graphsave= 0;	% saves spectrum plots (1 default)
...
sim.FileName= '130614329';
sim.ResultsPath= '/oldhome/vbettachini/documents/fibre/simulacion/130614results/130614analysis/';
...
% pump power iteration [InputField REQUIRES Ppeak]
pump.chirp= 7500* 1E-6;	% [fs^2 -> ps^2]
%{
it.chirpstart= -8E3;
it.chirpstep= 5E2;
...
%}
    ...
    [sim.FileName, sim.ResultsPath]= expFileNameNext(sim.FileName, sim.ResultsPath);
