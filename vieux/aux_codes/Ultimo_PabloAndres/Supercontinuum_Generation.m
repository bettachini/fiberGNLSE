...
% INPUT FIELD ***********************************************************
PeakPower = 50000; % W, change here the Input Power!
...
for ii=7:1:12,
tol = 10^-ii; % photon error number, or local error, depending on the used method. 
tic
...
% [u,nf] = IP_LEM_TD(u0,dt,L,dz,alpha,betaw,gamma,fo,tol);
    ...
    eval(['save ' 'Heidt50_IP_CQE_n15_T32_u' num2str(ii) ' u'])
    eval(['save ' 'Heidt50_IP_CQE_n15_T32_nf' num2str(ii) ' nf'])
